...
export default async function AboutPage() {
  const page = await loadPageForRequest('about');
    ...
    <section className="pt-12">
      <div className="container max-w-3xl">
        ...
        <p className="subtle mt-6">
          Deze pagina is nog niet gevuld in het CMS. Voeg secties toe via <code>/admin/pages/about</code> om de inhoud te beheren.
        </p>
      </div>
    </section>
  );
